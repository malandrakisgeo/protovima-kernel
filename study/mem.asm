...
_next_memory_range:
 ...
 ;Print total memory available 
  mov dword [dword 0x00000d000], ebp  ;/* e820 list(es:edi 0x07c0:0x1000) */  0x07c0*16 + 0x1000    0x8C00
  mov eax, strMuf
   mov dword [dword 0x00000df00], eax  ;/* e820 list(es:edi 0x07c0:0x1000) */  0x07c0*16 + 0x1000    0x8C00

 push ebp 
 push WORD [dword 0x00000df00]
 call print 
