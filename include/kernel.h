...
#define TEXT_BASE 0xB8000 //Default for colour monitors. TODO: Check if it actually is just for the Real mode, and the protected has some more effective way than VGA access
//#define VGA_ADDRESS	((void *)VADDR(TEXT_BASE))
